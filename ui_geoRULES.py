...
#
# Created: Sat Jan 23 23:20:43 2016
...
"font: 75 italic 10pt \"MS Shell Dlg 2\";"))
        ...
        self.reclassButtonBox.setStandardButtons(QtGui.QDialogButtonBox.Close|QtGui.QDialogButtonBox.Help)
        self.reclassButtonBox.setObjectName(_fromUtf8("reclassButtonBox"))
        self.applyRulesBtn = QtGui.QPushButton(self.RoulesQTBox)
        self.applyRulesBtn.setGeometry(QtCore.QRect(20, 400, 161, 23))
        self.applyRulesBtn.setObjectName(_fromUtf8("applyRulesBtn"))
        self.typeRuleCmBox = QtGui.QComboBox(self.RoulesQTBox)
        self.typeRuleCmBox.setGeometry(QtCore.QRect(190, 400, 101, 22))
        self.typeRuleCmBox.setObjectName(_fromUtf8("typeRuleCmBox"))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.applyRulesBtn.setText(_translate("Dialog", "Apply rules to maps", None))
